...
![正文排版示例：页面内容充实、版面利用充分](../../assets/dense_body_layout_example.png)
...
![AFlow Figure 3：左中右结构示例](../../assets/aflow_solution_overview.png)

![LEAD Figure 3：上下结构示例](../../assets/lead_solution_overview.png)
