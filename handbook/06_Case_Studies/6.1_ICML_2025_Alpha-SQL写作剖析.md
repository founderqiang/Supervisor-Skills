...
![Introduction 写作 Flowchart](../../assets/intro_flowchart_alpha_sql.png)
...
![Alpha-SQL Figure 1：性能预览图](../../assets/performance_teaser_example.png)

### Figure 3：Method Overview

这张图对应方法总览段落，帮助读者快速理解 Alpha-SQL 的搜索流程、动作空间和最终 SQL 选择机制。

![Alpha-SQL Figure 3：方法总览图](../../assets/alpha_sql_solution_overview.png)
